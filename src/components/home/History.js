...
import { HISTORY_CITY_NAME, HISTORY_DATE, HISTORY_NUMBER_PERSON, HISTORY_REMOVE_BTN, HISTORY_STRING } from "../../values/constains";
        ...
        <View>
            <View style={styles.hisHeader}>
                ...
                <TouchableOpacity activeOpacity={0.7} >
                    <Text ellipsizeMode="tail" numberOfLines={1} style={styles.headText, styles.btnDelete} >{HISTORY_REMOVE_BTN}</Text>
                </TouchableOpacity>
            </View>
