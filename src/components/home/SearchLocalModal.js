...
const generatePickerItem = (data = []) => {
    ...
    return data.map((el, index) => {
        return (<Picker.Item label={el.name} value={index} style={styles.pickerItemStyle} key={el.code} />)
    })
}
...
const SearchLocalModal = forwardRef((props, ref) => {
    ...
    useEffect(() => {
        async function getData() {
            ...
            let res = await addressApi.getDistrict(provinces[selectedProvince].code)
            let results = [...res.data.results]
    ...
    return (
        ...
        >
            <View style={styles.toolBar}>
                <TouchableWithoutFeedback style={{ width: 60, height: 60 }}><Icon name='arrow-left' color='#fff' size={20} onPress={() => setShow(false)} /></TouchableWithoutFeedback>
                <Text style={styles.toolbarText}>Chọn vị trí</Text>
            </View>
            <View style={styles.addressContainer}>
                <View style={styles.fieldStyle}>
                    <Text>Chọn Tỉnh / Thành Phố <Text style={styles.styleRequire}>*</Text></Text>
                    <View style={styles.pickerStyle}>
                        ...
                        >
                            <Picker.Item label="Chọn Tỉnh / Thành Phố" value={-1} style={styles.pickerItemStyle} />
                            {provincesPickerItem}
                        </Picker>
                    </View>
                </View>
                <View style={styles.fieldStyle}>
                    ...
                    <View style={styles.pickerStyle}>
                        ...
                        >
                            <Picker.Item label="Chọn Quận / Huyện" value={-1} style={styles.pickerItemStyle} />
                ...
                <View style={styles.fieldStyle}>
                    ...
                    <View style={styles.pickerStyle}>
                        ...
                        >
                            <Picker.Item label="Chọn Phường / Xã" value={-1} style={styles.pickerItemStyle} />
