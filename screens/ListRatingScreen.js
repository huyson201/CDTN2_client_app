...
import { Text, View, StyleSheet, TouchableWithoutFeedback, FlatList, ActivityIndicator } from 'react-native'
        ...
        <View style={{ flex: 1 }}>
            <View style={styles.toolbar}>
                ...
                <View style={styles.toolbarTitleBox}>
                    ...
                    <Text style={styles.toolbarHint}>Danh sách xếp hạng khách sạn này</Text>
                </View>
            </View>
