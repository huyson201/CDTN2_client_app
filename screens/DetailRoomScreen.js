...
const DetailRoomScreen = function () {
  ...
  return (
    <ScrollView>
      ...
      <View style={CRUDRoomsStyle.header}>
        <Title style={CRUDRoomsStyle.headerText}>ROOM DETAIL</Title>
      </View>
      <Container>
        ...
        <View style={CRUDRoomsStyle.PickerStyle}>
          ...
          <Picker
            ...
            <Picker.Item label="Rented" Color="blue" value="Rented" checked/>
            <Picker.Item label="Maintaining" Color="blue" value="Maintain" />
          </Picker>
        </View>
        <Button title="Delete" buttonStyle={CRUDRoomsStyle.daggerBtn}></Button>
      </Container>
    </ScrollView>
  );
};
